...
namespace BlogClassLibrary.DataAccessLayer
{
    public class ContextInitializer : DropCreateDatabaseIfModelChanges<BlogContext>
    {
        ...
        public ContextInitializer()
        {
            ...
            {
                new Owner{UserName = "FreedomFighter", Password = "-1623739142", FirstName = "Neil",LastName = "Kirkpatrick",Country = "Scotland",Email = "neil@angryscottsman.uk",Blogs = blogs,Description = "I'm a guy with 37 earthspins, who lives in Edinburgh with my wifey(wi-fi)!"}
            };
        }
